...
// other transcription entry point so a fix only has to be made once. This
// used to have its own copy here with a dangerous third-person "this is X"
// pattern (mislabels whoever is being introduced as the current speaker) and
// a first-match-wins bug (one false positive like "I'm Head of People..."
// permanently locked out a real self-intro later in the same conversation).
